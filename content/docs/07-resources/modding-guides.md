...
### BOSS - A Total Overhaul Project for Skyrim SE
...
### Skyrim SE Ultimate Modding Guide by Sinitar
...
I’m sure UI’s Micro List is great for running around Skyrim taking screenshots for half an hour, however it cannot possibly be considered a proper guide and there are fundamental errors as well as inconsistencies that lead me to strongly recommend against using it.