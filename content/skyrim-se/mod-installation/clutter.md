...
> The first five meshes conflict with and overwrite the arguably superior ones from Skyrim 3D Cooking. The blacksmith forge meshes overwrite Embers HD and prevent its forge textures from being applied. The textures from the plants folder are deleted because they overwrite fadingsignal's Scathecraw HD.
...
> The required mod, Barenziah's Glory, is included with Forgotten Retex Project.
