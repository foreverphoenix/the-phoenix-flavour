...
- [Reading Is Good](https://www.nexusmods.com/skyrimspecialedition/mods/42026) - Makes us become smarter in an immersive way by giving us a permanent boost to a levelling speed in a skill, which we have read about.
...
(`E` by default), while in the air. After finding and learning neat spell around the platform, use your shout key (`Z` by default) to fly higher. Paraglider can be used only in the third person.
