...
This update is big. It wasn't always meant to be that way. It was supposed to just be 4.19.1, the update where *Seasonal Landscapes - Unfrozen* was finally added in all of it's glory. However, as I went through making that happen and testing the results, I kept finding oddities that nagged at me until I was forced to reckon with the remnants of TPF 5.0 Beta that've been present in the list since 4.16.

As it removes all reference to TPF 5.0, it's only fitting that this version is called SSS 5.0 itself. A quick, quick summary of the massive list of changes below:

- Visuals have been overhauled. New lighting, new weather, a lot of new textures, and a switch from ENB to *Community Shaders*. The game is brighter with a fresh coat of paint, and should perform even better on your computer.
- *Weapons Armor Clothing and Clutter Fixes* has been removed. Still a great mod but it's been marked for removal since SSS 4.16 and this was finally the time to rip off the bandaid. Items have returned to *mostly* vanilla stats (there's still [Armor Rating Adjustment for Adamant](https://www.nexusmods.com/skyrimspecialedition/mods/83825)) for better consistency with added items.
- More Questing *At Your Own Pace*. The Companions and Thieves Guild have been switched over to the mod series, giving a bit more uniformity to the three main factions.
- *Seasonal Landscapes - Unfrozen* in all of its glory. The game's calendar has been changed to 28 day **seasons** so you'll see the change 3x as frequently as you would previously. The game starts in the middle of Summer where things are at their most temperate, followed by Autumn which is what most people are used to. Use this time to prepare for the brutal Winter Skyrim is known for.

**This version absolutely needs a new save file! Don't even try it. Seriously. Crash City.** Also keep is mind that this is an *Alpha* release. There's no guarantee that the next release will be save-safe with this one. This is primarily for testing and working out the bugs before releasing a *Beta* which is expected to be more stable and likely to be save-safe with the full release.

Pop the full details below for the list of changes.
...
- Added Achievements Mods Enabler
...
- Removed High Poly Fern Meshes by mindflux
- Removed Rudy HQ - More Lights for ENB - Nirnroots
- Removed Better Nirnroot
- Removed Mari's Reach Ferns - Vanilla Mesh Tweaks
...
- Removed Skyrim Landscape Overhaul - Stone Walls
...
- Added Seasonal Diverse Tundra Shrubs
- Added Seasonal Spiffed Up Tundra Scrubs
...
- **Valuable Objects:** Removed White Phial Replacer - ENB Light Addon
...
- **Quest Start Adjustments:** Added Realistic Dark Brotherhood Kidnapping
- **Quest Start Adjustments:** Adjusted edits to Thieves Guild radiant quests in TPF - Quest Mods Patch
...
- **Survival & Fishing:** Added Simple Fishing Overhaul
- **Survival & Fishing:** Added Simple Fishing Overhaul - FLM Addon
...
- **Cities of the North:** Removed COTN - Morthal - Skyrim 3D Signs Patch (included in the Patch Collection now)
...
- **New Creatures and Enemies:** Updated Imperial Armors and Weapons Retexture - Civil War Deserters Patch to include necessary textures from Imperial Armors and Weapons Retexture
- **New Animations:** Added Vanargand Animations II - Unarmed Non Combat Locomotion
- **New Animations:** Added Improved Idle Laydown Animations
- **Conflict Resolution:** Copied DBEntranceQuest `00050F2E` from The Choice is Yours to overwrite edits by Quest Conflict Fixes
...
- **Configuration:** Adjusted `bForceNPCsUseAmmo` to `0` in Skyrim.ini
...
- Updated Security Overhaul SKSE - Add-ons to 0.1.9.1
...
- Updated Adamant - A Perk Overhaul to 5.8.6
- Updated Adamant - Bard Perks Addon to 1.0.2
...
- Updated Gourmet - A Cooking Overhaul to 1.1.6
- Updated Gourmet - Fishing Patch to 1.0.3
...
- Updated Madmen - A Forsworn Overhaul to 2.0.2
- Updated Madmen - Patch Collection to 2.0.2
...
- Updated Weapon Styles - DrawSheathe Animations for IED to 2.0
- Updated U Can't Touch Fishto 1.0.2
- Updated Fishing - WACCF Patch to 4.0
- Updated Icy Windhelm to 2.4
- Updated COTN - Dawnstar to 1.4
- Updated COTN - Dawnstar - Patch Collection to 5.0
- Updated COTN - Morthal to 1.2
- Updated COTN - Morthal - Patch Collection to 3.1.1
- Updated aljo's Apothecary Patches - OCW Patch to 4.5
...
- Updated aljo's Apothecary Patches - SECSS Patch to 4.5
- Updated College of Winterhold - Quest Expansion to 1.15
...
- Updated Improved Table Transition Animations to 1.3
- Updated The Northerner Diaries - Immersive Edition to 1.3
- Updated Yet Another Music Merge to 1.1
- Updated Yet Another Music Merge - ECSS Patch to 1.1-ECSS
