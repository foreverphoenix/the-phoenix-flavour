...
- How bad is the performance impact with default / intended settings?
- Does it break vanilla imagespace?

Visuals are obviously subjective while performance depends on your hardware. You will likely have to install and test a preset before being able to decide whether you like it or not. Screenshots and showcase videos can be found on the mod pages for all presets.
...
A final consideration would be compatibility with vanilla imagespaces, specifically the **Nighteye** effect. With TPF you gain night vision as a Khajiit, vampire, or werewolf although you can also use the new spell, scroll, potion, and enchantment.
...
- **Support:** Rudy ENB is regularly updated.
...
Serio's is a good performance-friendly alternative to Rudy. It needs some tweaking in order to look good with Luminosity, our lighting overhaul. You can find the instructions in the guide later on (New Game >> ENB Tweaks).

- **Support:** Serio's ENB is updated occasionally.
...
Silent Horizons is an incredibly customisable preset available for a range of different weather overhauls, including Cathedral. The mod page features indepth instructions for personalising the preset.

- **Support:** Silent Horizons ENB has not been updated in a few months.
...
- **Support:** Semirealis ENB is kept up-to-date with the latest ENBSeries releases.
...
- **Support:** The Truth ENB is being updated occasionally.
