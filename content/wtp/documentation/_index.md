...
- [Better Female Sitting Animation](https://www.nexusmods.com/fallout4/mods/3426): Female player characters no longer sit like they're very shy or really have to pee.
...
- X-01 power armor pieces are rare. There is only a single full set in the Commonwealth.
...
As for **X-01 power armor**, there are only two full sets to be found: One of them is the [Quantum X-01](https://fallout.fandom.com/wiki/Quantum_X-01_power_armor) from the Nuka World DLC. The other consists of regular X-01 pieces you will have to gather from various locations around the Commonwealth. Scroll to the bottom of this page to the SPOILER SECTION to find out where exactly those six pieces can be found.
