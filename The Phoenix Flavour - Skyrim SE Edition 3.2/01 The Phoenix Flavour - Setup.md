...
You can find all mod installation instructions in the [02 The Phoenix Flavour - Mod Installation.md](README.md) file. I highly recommend opening it in a new tab or window while keeping this one open so that you are able to refer to the instructions detailed below while installing the mods.
